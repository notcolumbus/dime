  ...
  return (
    <div className="w-full rounded-2xl py-4 pl-0 pr-0">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <span className="text-white text-2xl">alternative payment methods</span>
      </div>

      {/* Cards List */}
      <div className="flex flex-col gap-12">
        {cards.map((item, index) => (
          <div key={index} className="flex items-stretch justify-between gap-8">
            {/* Left side - Card */}
            ...
            <div className="flex flex-col justify-end flex-1">
              <div className="text-white text-3xl font-bold">{item.cashbackPercentage}%</div>
              <div className="text-white text-xl">cashback</div>
              <div className="text-gray-400 text-sm mt-2">{item.subtext}</div>
              <button
